...
loop feedback back to `agy` or present to the human.
...
Write to `.antigravity-delegate/feedback-<n>.md`:
...
Then re-dispatch with `AGY_FEEDBACK` (same model unless the human re-chooses).
